...
class PointConvD(nn.Module):
    ...
    def forward(self, xyz, points):
        ...
        fps_idx = pointnet2_utils.furthest_point_sample(xyz, self.npoint) #[1, N]

        new_xyz = index_points_gather(xyz, fps_idx) #[B, N, 3]
...
class UpsampleFlowv1(nn.Module):
    def forward(self, xyz, sparse_xyz, sparse_flow, n=3):
        # import ipdb; ipdb.set_trace()
        ...
        knn_idx = knn_point(n, sparse_xyz, xyz)  #[B, N, 5]
